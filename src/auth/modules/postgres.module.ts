...
import { User } from '@auth/infrastructure/entities/postgres';
import { PostgresAuthRepository } from '@auth/infrastructure/repository';
...
@Module({
  ...
  imports: [
    CONFIG_DATABASE_POSTGRES_ENTITY(User, Connection.auth.name),
