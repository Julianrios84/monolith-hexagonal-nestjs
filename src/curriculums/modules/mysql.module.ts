...
import { MySQLCurriculumRepository } from '@curriculums/infrastructure/repository';
import {  CurriculumController } from '@curriculums/infrastructure/curriculum.controller';

@Module({
  controllers: [CurriculumController],
  imports: [
    CONFIG_DATABASE_MYSQL_ENTITY(Curriculum, Connection.curriculum.name),
  ],
  providers: [
    CurriculumService,
    {
      provide: IRepository,
      useClass: MySQLCurriculumRepository,
    },
    {
