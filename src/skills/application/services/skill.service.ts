...
import { ICreateDto, IDeleteDto, IGetDto, IUpdateDto } from "@skills/domain/dto";
import { ICreateUseCase, IDeleteUseCase, IFindAllUseCase, IFindInUseCase, IFindOneUseCase, IUpdateUseCase } from "@skills/domain/ports";
