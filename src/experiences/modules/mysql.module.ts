...
import { MySQLExperienceRepository } from '@experiences/infrastructure/repository';
import { ExperienceController } from '@experiences/infrastructure/experience.controller';

@Module({
  controllers: [ExperienceController],
  imports: [
    CONFIG_DATABASE_MYSQL_ENTITY(Experience, Connection.experience.name),
  ],
  providers: [
    ExperienceService,
    {
      provide: IRepository,
      useClass: MySQLExperienceRepository,
    },
    {
