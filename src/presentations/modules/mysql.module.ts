...
import { MySQLPresentationRepository } from '@presentations/infrastructure/repository';
import { PresentationController } from '@presentations/infrastructure/presentation.controller';

@Module({
  controllers: [PresentationController],
  imports: [
    CONFIG_DATABASE_MYSQL_ENTITY(Presentation, Connection.presentation.name),
  ],
  providers: [
    PresentationService,
    {
      provide: IRepository,
      useClass: MySQLPresentationRepository
    },
    {
