...
import { ICreateDto, IDeleteDto, IGetDto, IUpdateDto } from "src/courses/domain/dto";
import { ICreateUseCase, IDeleteUseCase, IFindAllUseCase, IFindInUseCase, IFindOneUseCase, IUpdateUseCase } from "src/courses/domain/ports";
