...
import { MySQLEducationRepository } from '@educations/infrastructure/repository';
import {  EducationController } from '@educations/infrastructure/education.controller';

@Module({
  controllers: [EducationController],
  imports: [
    CONFIG_DATABASE_MYSQL_ENTITY(Education, Connection.education.name),
  ],
  providers: [
    EducationService,
    {
      provide: IRepository,
      useClass: MySQLEducationRepository,
    },
    {
