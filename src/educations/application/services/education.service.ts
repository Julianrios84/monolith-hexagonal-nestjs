...
import { ICreateDto, IDeleteDto, IGetDto, IUpdateDto } from "src/educations/domain/dto";
import { ICreateUseCase, IDeleteUseCase, IFindAllUseCase, IFindInUseCase, IFindOneUseCase, IUpdateUseCase } from "src/educations/domain/ports";
