...
import { ICreateDto, IDeleteDto, IGetDto, IUpdateDto } from "@personals/domain/dto";
import { ICreateUseCase, IDeleteUseCase, IFindAllUseCase, IFindOneUseCase, IUpdateUseCase } from "@personals/domain/ports";
