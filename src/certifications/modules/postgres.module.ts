...
import { PostgresCertificationRepository } from '@certifications/infrastructure/repository';
import { CertificationController } from '@certifications/infrastructure/certification.controller';

@Module({
  controllers: [CertificationController],
  imports: [
    CONFIG_DATABASE_POSTGRES_ENTITY(Certification, Connection.certification.name),
  ],
  providers: [
    CertificationService,
    {
      provide: IRepository,
      useClass: PostgresCertificationRepository
    },
    {
