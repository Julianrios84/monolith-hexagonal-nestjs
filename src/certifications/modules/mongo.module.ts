...
import { MongoCertificationRepository } from '@certifications/infrastructure/repository';
import { CertificationController } from '@certifications/infrastructure/certification.controller';

@Module({
  controllers: [CertificationController],
  imports: [
    CONFIG_DATABASE_MONGO_ENTITY(Certification, Connection.certification.name),
  ],
  providers: [
